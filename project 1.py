...
#"===========================Data Frame Left==============="
        ...
        lblNameTable=Label(DataframeLeft,font=("arial",12,"bold"),text="Name of The Tablet",padx=2,pady=6)
        ...
        comNameTable["value"]=("Nice","Corono Vaccine","Acetminophen","Adderall","Amlodine","Ativan")
        ...
        txtNoofTables=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
        ...
        lblissuedate=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
        lblissuedate.grid(row=5,column=1)

        lblExpdate=Label(DataframeLeft,font=("arial",12,"bold"),text="Exp date:",padx=2,pady=4)
        lblExpdate.grid(row=6,column=0,sticky=W)
        lblExpdate=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
        lblExpdate.grid(row=6,column=1)

        lblDailydose=Label(DataframeLeft,font=("arial",12,"bold"),text="Daily Dose:",padx=2,pady=4)
        lblDailydose.grid(row=7,column=0,sticky=W)
        lblDailydose=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
        ...
        lblSideeffect=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
        ...
        lblFurtherinfo=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
        ...
        lblPatientName=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
        ...
        lblDateOfBirth=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
        ...
        lblPatientAddress=Entry(DataframeLeft,font=("arial",13,"bold"),width=35)
...
#"==========Data Frame Right==============="
        ...
        btnprescriptionData=Button(Buttonframe,command=self.iprescription_data,text="Prescription Data",bg="Green",fg="White",font=("arial",12,"bold"),width=23,padx=2,pady=6)
        ...
        self.hospital_table=ttk.Treeview(frameDetails,column=("nameOfTable","ref","dose","nooftablets","lot","issuedate","expdate","dailydose","storage","nhsnumber","pname","dob","address"),xscrollcommand=
...
#"==========================Functionality Declaration"
    def iprescription(self):
        if self.NameOftablets.get()=="" or self.ref.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost",user="root",password='Dinesh@6267',database="dinesh",port=3306)
    ...
    def iprescription_data(self):
        ...
        self.txtprescription.insert(END,"HowToUseMedications:\t\t\t"+self.HowToUseMedications.get()+"\n")
    ...
    def idelete(self):
            conn=mysql.connector.connect(host="localhost",user="Dinesh",password='Dinesh@123',db="table",port=3306)
            my_cursor=conn.cursor()
    ...
    def iexit(self):
        iexit=messagebox.askyesno("Hospital Management System","Confirm you want")
        if iexit>0:
            root.destroy()
            return
