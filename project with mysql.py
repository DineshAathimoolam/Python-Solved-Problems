...
def Add():
    ...
    mysqldb=mysql.connector.connect(host="localhost",user="root",password="Dinesh@6267",database="World")
...
def update():
    ...
    coursename = e3.get()
    feee = e4.get()
    mysqldb=mysql.connector.connect(host="localhost",user="root",password="Dinesh@6267",database="details")
    mycursor=mysqldb.cursor()
